...
./configure --host=mipsel-linux --with-ssl=$HOME/openssl-install/$ARCH --enable-static --disable-manual --disable-ipv6 --disable-shared --disable-FILE --disable-FTP --disable-GOPHER --disable-IMAP --disable-POP3 --disable-RTSP --disable-SMTP --disable-TELNET --disable-TFTP --prefix=$HOME/curl_install/$ARCH
#make V=1
