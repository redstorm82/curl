...
./configure --host=mipsel-linux --disable-manual --disable-ipv6 --disable-shared --disable-FILE --disable-FTP --disable-GOPHER --disable-IMAP --disable-POP3 --disable-RTSP --disable-SMTP --disable-TELNET --disable-TFTP --prefix=$HOME/curl_install/mipsel
#make V=1
#make && make install
